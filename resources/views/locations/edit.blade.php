...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-header p-3">Edit Location</div>
                ...
                <form method="POST" action="{{ route('locations.update', $location) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="company_id" class="form-select">
                            ...
                            <option value="{{ $co->id }}" @selected(old('company_id', $location->company_id) == $co->id)>{{ $co->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    @endif
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                            value="{{ old('name', $location->name) }}" placeholder="Main Office" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="address" class="form-control"
                            value="{{ old('address', $location->address) }}" placeholder="123 Street, Phnom Penh">
                    </div>
                    ...
                    <div class="row g-2 mb-3">
                        <div class="col">
                            ...
                            <input type="number" name="latitude" step="any"
                                ...
                                id="latInput" value="{{ old('latitude', $location->latitude) }}"
                        ...
                        <div class="col">
                            ...
                            <input type="number" name="longitude" step="any"
                                ...
                                id="lngInput" value="{{ old('longitude', $location->longitude) }}"
                    ...
                    <div class="mb-4">
                        <label class="form-label fw-semibold">
                            Allowed Radius: <span id="radiusLabel">{{ old('radius_meters', $location->radius_meters) }}</span>m
                        </label>
