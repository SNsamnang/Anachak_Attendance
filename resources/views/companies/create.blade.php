...
<div class="d-flex align-items-center gap-2 mb-3">
    ...
    <h6 class="mb-0 fw-semibold">Create Company</h6>
</div>
        ...
        <form method="POST" action="{{ route('companies.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="code" class="form-control font-monospace text-uppercase"
                    value="{{ old('code') }}" placeholder="e.g. ACME" maxlength="20">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="telegram_bot_token" class="form-control font-monospace"
                    value="{{ old('telegram_bot_token') }}" placeholder="123456:ABC-DEF...">
            </div>
            <div class="mb-3">
                ...
                <input type="text" name="telegram_chat_id" class="form-control font-monospace"
                    value="{{ old('telegram_chat_id') }}" placeholder="-1001234567890">
            </div>
